  ...
  const data = [
    {
      ...
      content: (
        <div>
          <h3 className="mb-4 text-lg font-semibold text-neutral-900 md:text-xl dark:text-neutral-100">
            Discovery
          </h3>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            We create a comprehensive roadmap for success
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://assets.aceternity.com/templates/startup-1.webp"
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            We build with precision and innovation
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://assets.aceternity.com/templates/startup-1.webp"
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            We ensure a smooth deployment and support
          </p>
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://assets.aceternity.com/templates/startup-1.webp"
    ...
    <section className="relative z-10 px-6 py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg md:text-xl text-neutral-300 ml-8">
